...
where LENGTH("TB Registration".value) <= 18 and ou.organisationunitid IN(select organisationunitid FROM organisationunit WHERE path like '%${oranisatiounituid}%') and pi.enrollmentdate BETWEEN '${startDate}' AND '${endDate}' 
group by 
instance, 
"TB Registration", 
"First Name", 
