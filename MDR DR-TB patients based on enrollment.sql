...
where pi.programid IN (8558) and pi.organisationunitid IN(select organisationunitid FROM organisationunit WHERE path like '%${oranisatiounituid}%') and pi.enrollmentdate BETWEEN '${startDate}' AND '${endDate}' 
group by 
instance,
"TB Registration",
"First Name",
