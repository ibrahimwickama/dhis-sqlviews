...
"TB Registration".trackedentityattributeid as "Reg attributeid"
...
where psi.programstageid IN (15177) and LENGTH("TB Registration".value) <17 or "TB Registration".value in ('*','@','/k/','-','_') and pi.organisationunitid IN(select organisationunitid FROM organisationunit WHERE path like '%${oranisatiounituid}%') and pi.enrollmentdate BETWEEN '${startDate}' AND '${endDate}' 
group by 
instance,
"TB Registration",
"First Name",
