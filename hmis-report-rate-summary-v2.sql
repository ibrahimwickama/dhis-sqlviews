SELECT
	DISTINCT ON (outer_orgunit.hierarchylevel,grandparentname,parent.name,outer_orgunit.name)
    (SELECT name
	...
	(
		SELECT COUNT(DISTINCT (completedatasetregistration.datasetid, completedatasetregistration.periodid, completedatasetregistration.sourceid))
