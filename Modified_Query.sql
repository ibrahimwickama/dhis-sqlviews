...
left join dataelement de on de.dataelementid = ted.dataelementid
left join trackedentityattribute tea on tea.trackedentityid = tei.trackedentityid
...
where ted.dataelementid = 6993 and ted.value = '0' and "Source of referrals".value = 'CTC'